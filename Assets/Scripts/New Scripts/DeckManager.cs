...
public class DeckManager : MonoBehaviour
{
    ...
    public void ShowNoOwnedCardsText()
    {
        //ownedCardsGameObject.SetActive(false);
        noOwnedCardsGameObject.SetActive(true);
    }


    public void ShowNoOffenseCardsText()
    {
    ...
    public void ShowNoDefensiveCardsText()
    {
    ...
    public void HideNoOwnedCardsText()
    {
        //  ownedCardsGameObject.SetActive(true);
        noOwnedCardsGameObject.SetActive(false);
        
    }

    public void HideNoOffensiveCardsText()
    {
    ...
    public void HideNoDefensiveCardsText()
    {
